...
- (void)viewDidLoad {
    ...
    self.titleLabel.text = [NSString stringWithFormat:NSLocalizedString(@"%@ Plus", nil), [[RJParseTemplate currentTemplate] name]];
    ...
    if (template.appIconImageURL) {
        ...
        [self.icon setTintableImageEntity:entity formatName:kRJAssetImageFormatAppIcon placeholder:nil];
    }
