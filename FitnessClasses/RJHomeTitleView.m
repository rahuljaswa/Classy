...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        if (template.wordmarkImageURL) {
            RJAssetImageCacheEntity *entity = [[RJAssetImageCacheEntity alloc] initWithAssetImageURL:[NSURL URLWithString:template.wordmarkImageURL]];
            [_titleView setTintableImageEntity:entity formatName:kRJAssetImageFormatWordmark placeholder:nil];
        }
