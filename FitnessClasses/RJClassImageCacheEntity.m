...
NSString *const kRJImageFormatFamilyClass = @"RJImageFormatFamilyClass";

NSString *const kRJClassImageFormatCardSquare16BitBGR = @"RJClassImageFormatCardSquare16BitBGR";
NSString *const kRJClassImageFormatCard16BitBGR = @"RJClassImageFormatCard16BitBGR";

CGSize const kRJClassImageSizeCard = {640, 640};


@interface RJClassImageCacheEntity ()
...
@implementation RJClassImageCacheEntity
...
- (FICEntityImageDrawingBlock)drawingBlockForImage:(UIImage *)image withFormatName:(NSString *)formatName {
    FICEntityImageDrawingBlock drawingBlock = ^(CGContextRef context, CGSize contextSize) {
        ...
        BOOL squareCrop = [formatName isEqualToString:kRJClassImageFormatCardSquare16BitBGR];
