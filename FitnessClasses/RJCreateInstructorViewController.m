//
//  RJCreateInstructorViewController.m
//  FitnessClasses
//
...
#import <UIToolkitIOS/RJLabelCell.h>
...
@interface RJCreateInstructorViewController () <UICollectionViewDelegateFlowLayout, UITextFieldDelegate>
...
@implementation RJCreateInstructorViewController
            ...
            if (self.name) {
                ...
                [RJParseUtils createCategoryWithName:self.name completion:^(BOOL success) {
                    if (success) {
                        ...
                        if ([self.createDelegate respondsToSelector:@selector(createInstructorViewControllerDidCreateInstructor:)]) {
                            [self.createDelegate createInstructorViewControllerDidCreateInstructor:self];
                        }
                    } else {
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = [NSLocalizedString(@"Create Instructor", nil) uppercaseString];
