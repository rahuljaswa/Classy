...
NSString *const kRJImageFormatFamilyTrack = @"RJImageFormatFamilyTrack";

NSString *const kRJTrackImageFormatCardSquare16BitBGR = @"RJTrackImageFormatCardSquare16BitBGR";
NSString *const kRJTrackImageFormatCard16BitBGR = @"RJTrackImageFormatCard16BitBGR";

CGSize const kRJTrackImageSizeCard = {640, 640};


@interface RJTrackImageCacheEntity ()
...
@implementation RJTrackImageCacheEntity
...
- (FICEntityImageDrawingBlock)drawingBlockForImage:(UIImage *)image withFormatName:(NSString *)formatName {
    FICEntityImageDrawingBlock drawingBlock = ^(CGContextRef context, CGSize contextSize) {
        ...
        BOOL squareCrop = [formatName isEqualToString:kRJTrackImageFormatCardSquare16BitBGR];
