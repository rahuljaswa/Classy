...
#import <UIToolkitIOS/UIColor+RJAdditions.h>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (tutorialPage) {
        case kTutorialPageWelcome:
            cell.textLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Welcome to %@", nil), [[RJParseTemplate currentTemplate] name]];
        ...
        case kTutorialPageGetStarted: {
            ...
            if (template.appIconImageURL) {
                ...
                [cell.imageView setTintableImageEntity:entity formatName:kRJAssetImageFormatAppIcon placeholder:nil];
            }
